        ...
        args = {
            ...
            background = {
                ...
                args = {
                    ...
                    backgroundOpacity = {
                        ...
                        desc = "Controls the transparency of the entire tooltip background. 0 = fully transparent, 1 = fully solid. This overrides the alpha value from the color picker above.",
                        type = "range",
                        order = 2.5,
                        min = 0,
                        max = 1,
                        ...
                        isPercent = true,
                        disabled = function() return not (EpicTipDB and EpicTipDB.enabled) end,
                        get = function() return EpicTipDB and EpicTipDB.backgroundOpacity or 0.8 end,
                        set = function(_, val)
                            if EpicTipDB then EpicTipDB.backgroundOpacity = val end
                            if ET and ET.SaveConfig then ET:SaveConfig() end
                        end,
                    },
                    backgroundFade = {
            ...
            border = {
                ...
                args = {
                    ...
                    maxTooltipWidth = {
                        name = "Maximum Tooltip Width",
                        desc = "Wrap long lines to keep tooltip within this width",
                        type = "range",
                        order = 4,
                        min = 300,
                        max = 900,
                        step = 10,
                        disabled = function() return not (EpicTipDB and EpicTipDB.enabled) end,
                        get = function() return EpicTipDB and EpicTipDB.maxTooltipWidth or 550 end,
                        set = function(_, val) 
                            if EpicTipDB then EpicTipDB.maxTooltipWidth = val end
                            if ET and ET.SaveConfig then ET:SaveConfig() end
                        end,
                    },
                    classColoredBorder = {
