    ...
    return {
        ...
        args = {
            ...
            healthbars = {
                ...
                args = {
                    healthHeader = {
                        name = isRetail and "|cFFFF6347» Health Bar Visibility|r\n\nControl the display of health bars in tooltips. Health bars show current HP but can clutter the interface for some users."
                              or "|cFFFF6347» Health Bar Visibility|r\n\nControl the display of health bars in tooltips. Note: Health values are only available for grouped players in Classic/Era.",
                        type = "description",
                        order = 1,
                        fontSize = "medium",
                    },
